...
Shader "VFX/fire"
{
	Properties
	{
		...
		_Float0("主贴图角度", Float) = 0
		_Float3("范围1外焰", Range( 0 , 1)) = 0.09768958
		_Float5("范围2内焰", Range( 0 , 1)) = 0
		_溶解进度("溶解进度", Range( 0 , 1)) = 0.1567947
		[HDR]_Color2("Color 2", Color) = (1,0.9839049,0.4705882,0)
		[ASEEnd][HDR]_Color3("Color 3", Color) = (1,0.5018868,0.5018868,0)
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 ShadowCoords = float4( 0, 0, 0, 0 );
					...
					#endif
				#endif
				float2 texCoord467 = IN.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float cos466 = cos( radians( _Float0 ) );
				float sin466 = sin( radians( _Float0 ) );
				float2 rotator466 = mul( texCoord467 - float2( 0.5,0.5 ) , float2x2( cos466 , -sin466 , sin466 , cos466 )) + float2( 0.5,0.5 );
				float4 tex2DNode463 = tex2D( _TextureSample0, rotator466 );
				float temp_output_471_0 = step( ( _Float5 + _溶解进度 ) , tex2DNode463.r );
				float4 lerpResult480 = lerp( ( temp_output_471_0 * _Color2 ) , _Color3 , step( _Float3 , tex2DNode463.r ));
				
				float3 BakedAlbedo = 0;
				float3 BakedEmission = 0;
				float3 Color = lerpResult480.rgb;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18935
-240.4;112;1328;740.4;-1621.644;1129.741;1.6;True;False
Node;AmplifyShaderEditor.RangedFloatNode;469;502.1098,-635.1617;Inherit;False;Property;_Float0;主贴图角度;6;0;Create;False;0;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;481;2451.652,-1069.993;Inherit;False;Property;_Color3;Color 3;11;1;[HDR];Create;True;0;0;0;False;0;False;1,0.5018868,0.5018868,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;479;2278.728,-279.1654;Inherit;False;Property;_Color2;Color 2;10;1;[HDR];Create;True;0;0;0;False;0;False;1,0.9839049,0.4705882,0;1,0.9839049,0.4705882,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;464;1774.766,-1008.335;Inherit;False;Constant;_Color0;Color 0;6;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;477;2920.519,-272.4641;Inherit;False;476;alpha;1;0;OBJECT;;False;1;FLOAT;0
Node;AmplifyShaderEditor.ColorNode;465;1290.724,-66.0613;Inherit;False;Constant;_Color1;Color 1;6;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.LerpOp;480;2998.903,-580.9422;Inherit;True;3;0;COLOR;0,0,0,0;False;1;COLOR;0,0,0,0;False;2;FLOAT;0;False;1;COLOR;0
Node;AmplifyShaderEditor.RotatorNode;466;1007.704,-790.8842;Inherit;False;3;0;FLOAT2;0,0;False;1;FLOAT2;0.5,0.5;False;2;FLOAT;0;False;1;FLOAT2;0
Node;AmplifyShaderEditor.RegisterLocalVarNode;476;2058.918,-151.1687;Inherit;False;alpha;-1;True;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;470;2055.674,-753.8379;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;472;1329.757,-935.6938;Inherit;False;Property;_Float3;范围1外焰;7;0;Create;False;0;0;0;False;0;False;0.09768958;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;471;1894.133,-524.2395;Inherit;True;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleAddOpNode;474;1706.675,-495.1455;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.TextureCoordinatesNode;467;658.6094,-815.9936;Inherit;False;0;-1;2;3;2;SAMPLER2D;;False;0;FLOAT2;1,1;False;1;FLOAT2;0,0;False;5;FLOAT2;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;463;1367.549,-821.4902;Inherit;True;Property;_TextureSample0;Texture Sample 0;5;0;Create;True;0;0;0;False;0;False;-1;f28576d1a93dd88468caa39bb174e7ec;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;475;1441.758,-409.7733;Inherit;False;Property;_溶解进度;溶解进度;9;0;Create;True;0;0;0;False;0;False;0.1567947;0;0;1;0;1;FLOAT;0
Node;AmplifyShaderEditor.RadiansOpNode;468;734.4297,-604.4418;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;478;2584.131,-433.8365;Inherit;True;2;2;0;FLOAT;0;False;1;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.RangedFloatNode;473;1428.039,-560.2565;Inherit;False;Property;_Float5;范围2内焰;8;0;Create;False;0;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
WireConnection;466;2;468;0
WireConnection;476;0;471;0
WireConnection;470;0;472;0
WireConnection;470;1;463;1
WireConnection;471;0;474;0
WireConnection;471;1;463;1
...
WireConnection;423;2;480;0
ASEEND*/
//CHKSM=0FEF54693F1886D6C6F27920BB9414E820E819EB